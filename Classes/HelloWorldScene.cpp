...
bool HelloWorld::init()
{
    ...
    CCSprite* spt=CCSprite::createWithSpriteFrameName("laoshuAction/0000");
    
    int i;
    //空闲动作
    CCArray *idleFrames = CCArray::createWithCapacity(40);
    for (i = 0; i < 39; i++)
    {
        CCSpriteFrame *frame = CCSpriteFrameCache::sharedSpriteFrameCache()->spriteFrameByName(CCString::createWithFormat("laoshuAction/00%02d", i)->getCString());
